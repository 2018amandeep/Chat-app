            ...
            border-r border-gray-700 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                ...
                <div className="p-6 border-b border-gray-700">
                    <div className="sm:hidden flex justify-end mb-0">
                        ...
                        transition-colors"><X className="w-5  h-5 text-gray-300"></X></button>
                    </div>
                                ...
                                <div className="space-y-2 overflow-y-auto h-full pb-4">
                                    {
                                        chats.map((chat) => {
                                            ...
                                            ${isSelected ?
                                                        ...
                                                        "border border-gray-700 hover:boder-gray-600"
                                                    }
                                        `}
                                            >
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center justify-between mb-1">
                                                            ...
                                                            {unseenCount > 0 && (
                                                                <div className="bg-red-600 text-white text-xs font-bold rounded-full min-w-[22px]
                                                h-5 flex items-center justify-center px-2">
                                                        ...
                                                        </div>
                                                        {
                                                            latestMessage && <div className="flex items-center gap-2">
                                                                ...
                                                                <span className="ext-sm text-gray-400 truncate flex-1">{latestMessage.text}</span>
                                                            </div>
                                                        }
                                                    </div>
                                                </div>
