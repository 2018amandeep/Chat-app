...
const VerifyOtp = () => {
    ...
    const handlePaste = (e: React.ClipboardEvent<HTMLInputElement>): void => {
        ...
        const digits = pastedData.replace(/\D/, "").slice(0, 6);
                            ...
                            <div className="flex justify-center in-checked: space-x-3">
                                {otp.map((digit, index) => (
                                    <input
                                        ...
                                        className='w-12 h-12 text-center text-x1 font-bond border-2 border-gray-600 rounded-lg bg-gray-700 text-white'
                                    />
                                ))}
                            </div>
                        </div>
